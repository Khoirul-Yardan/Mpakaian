...
<style>
  ...
  * {
  ...
  .styled-input__placeholder-icon {
    position: absolute;
    left: 15px;
    top: 50%;
  ...
  /* Sembunyikan icon saat input aktif atau ada isinya */
.styled-input__input:focus ~ .styled-input__placeholder .styled-input__placeholder-icon,
.styled-input__input:not(:placeholder-shown) ~ .styled-input__placeholder .styled-input__placeholder-icon {
  opacity: 0;
  visibility: hidden;
  pointer-events: none;
}
...
<main>
  <div class="video">
    <video autoplay loop muted>
      <source src="pius.mp4" type="video/mp4">
    </video>
  ...
  <form class="form" method="POST">
    ...
    <div class="form__content">
      ...
      <div class="styled-input">
        <input type="email" name="email" class="styled-input__input" name="nickname">
        <div class="styled-input__placeholder">
          <span class="styled-input__placeholder-text">Email</span>
          <span class="styled-input__placeholder-icon"></span>
        </div>
      ...
      <div class="styled-input">
        ...
        <div class="styled-input__placeholder">
         <span class="styled-input__placeholder-text">Password</span>
          <span class="styled-input__placeholder-icon"><ion-icon name="lock-closed"></ion-icon></span>
        </div>
        <div class="styled-input__circle"></div>
      </div>
      <button type="submit" name="login" class="styled-button">
